...
public class Startup extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent bootintent) {
        ...
        if (!mSetupRunning) {
            ...
            if (DEBUG)
                Log.d(TAG, "sharedpreferences.contains(" + PREF_SELINUX_MODE + "): "
                        + (sharedpreferences.contains(PREF_SELINUX_MODE) ? "True" : "False"));
            ...
            if (sharedpreferences.contains(PREF_SELINUX_MODE)) {
                ...
                if (DEBUG)
                    Log.d(TAG, String.format("currentIsSelinuxEnforcing: %s, isSelinuxEnforcing: %s",
                            (currentIsSelinuxEnforcing ? "True" : "False"), (isSelinuxEnforcing ? "True" : "False")));
