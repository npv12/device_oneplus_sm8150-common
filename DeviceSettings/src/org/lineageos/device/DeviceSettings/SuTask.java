...
public abstract class SuTask<Params> extends AsyncTask<Params, Void, Boolean> {
    ...
    abstract protected void sudoInBackground(Params... params) throws SuShell.SuDeniedException;
    ...
    protected void onPostExecute(Boolean result) {
        ...
        if (!result) {
            Toast.makeText(mContext, mContext.getString(R.string.cannot_get_su), Toast.LENGTH_LONG).show();
        }
    }
}
